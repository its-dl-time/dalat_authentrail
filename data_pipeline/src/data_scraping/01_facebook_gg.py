...
PLACES_FILE = PIPELINE_ROOT / "data" / "processed" / "places_master_top50.csv"
OUTPUT_DIR = PIPELINE_ROOT / "data" / "outputs" / "facebook"
...
def infer_source_type(url):
    ...
    if any(x in u for x in ["/posts/", "/permalink/", "/photos/", "photo.php", "story.php"]):
        return "post"
